...
<div class="header_resize_1" >
    ...
    <div class="button">
        <a href="https://myacn.acninc.com/MyACN/homePage.do">Admin</a>
    </div>
    <div class="clear"> </div>

    <div class="button">
        <a href="http://acneuro.co.uk">Online Registration</a>
    </div>
    <div class="clear"> </div>

    <div class="button">
        <a href="https://myacn.acninc.com/MyACN/RAPDFDownload.do">Manual registation Form</a>
    </div>
    ...
    <div class="button">
        <a href="/fu">First Utility Tools</a>
    </div>
    <div class="clear"> </div>

    <div class="button">
        <a href="/vm">Virgin Media Tools</a>
    </div>
    <div class="clear"> </div>
